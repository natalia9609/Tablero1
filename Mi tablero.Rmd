...
pie(t1, main="Categorias", col=c("#007979", "#009393", "#00AEAE", "#00CACA", "#00E3E3"))
```
...
```{r}
# seleccion de bases
dataFc4=subset(CarreraLuz22, (CarreraLuz22$sex=="Mujer" & CarreraLuz22$edad))
x=dataFc4$edad
hist(x, xlim=c(15,80), ylim=c(0,200), las=1,main = "edad de las mujeres", xlab="Edad", ylab = "frecuencia",
col ="#00CACA")
```

### Edad de hombres
```{r}
dataFc4=subset(CarreraLuz22, (CarreraLuz22$sex=="Hombre" & CarreraLuz22$edad))
x=dataFc4$edad
hist(x, xlim=c(15,76), ylim=c(0,300), las=1,main = "edad de los hombres", xlab="Edad)", ylab = "frecuencia",
col ="#00CACA")
```
...
main = "Tiempo mujeres categoría Abierta",
xlab="tiempo (min)",
ylab = "frecuencia",
col ="#00CACA")
```
...
main = "Tiempo hombres categoría Abierta",
xlab="tiempo (min)",
ylab = "frecuencia",
col ="#00CACA")
```
...
```{r}
paleta6=c("#007979", "#009393", "#00AEAE", "#00CACA", "#00E3E3","#00FFFF")

p1=ggplot(CarreraLuz22F, aes(y=timerun/60, x=categoria))+
  geom_jitter(color="#00CACA", size=1, alpha=0.9) +
  aes(color=paleta6)+
  labs(title = " ", main="Tiempos de carrera por categoria",
       y= "tiempo - min",
       x= "categorías")+ 
  #facet_wrap(~ sex)
...
ggplot(CarreraLuz22M, aes(x = categoria, y = timerun/60 )) +
  ...
  labs(title = "", main="Hombre por categorías", y= "tiempo - min", x= "categorías")+
  scale_fill_brewer() +
  #scale_fill_manual(values = c("#007979", "#009393", "#00AEAE", "#00CACA", "#00E3E3","#00FFFF"))+
...
ggplot(CarreraLuz22F, aes(x = categoria, y = timerun/60 )) +
  geom_boxplot(aes(fill = categoria)) + 
  # facet_wrap(~sex, ncol=1, labeller = labeller(dose = etiquetas))+
  labs(title = "",main= "Mujeres por categoría", y= "tiempo - min", x= "categorías")+
  scale_fill_brewer() +
  #scale_fill_manual(values = c("#007979", "#009393", "#00AEAE", "#00CACA", "#00E3E3","#00FFFF"))+
  theme(legend.position = "none")
t2m
